## This functions compute the inverse of the special "matrix" returned by function makeCacheMatrix. 
...
cacheSolve <- function(x, ...) {                   
  ...
  data  <- x$get()                                 # if not be cached, calculate the inverse of the matrix
